...
export default function FinOpsCopilotPage() {
  useEffect(() => { document.title = "FinOps Copilot | NRM Analytix"; }, []);
        ...
        <Container maxWidth="lg">
          ...
          <Box sx={{ mb: { xs: 5, sm: 6, md: 8 }, textAlign: { xs: 'center', md: 'left' } }}>
            ...
            <FadeUp delay={200}>
              <Typography variant="h5" sx={{ color: '#7c3aed', fontWeight: 400, fontSize: { xs: '1rem', sm: '1.2rem', md: '1.4rem' }, maxWidth: { xs: '100%', md: '80%' }, mx: { xs: 'auto', md: 0 } }}>
                AI-Driven Unit Economics and Multi-Cloud Spend Anomaly Detection Contextualizer
              </Typography>
            </FadeUp>
          </Box>
          ...
          <FadeUp delay={300}>
            <Card elevation={0} sx={{ display: 'flex', flexDirection: { xs: 'column', md: 'row' }, alignItems: 'stretch', gap: { xs: 3, md: 6 }, px: { xs: 3, md: 5 }, py: { xs: 2.5, md: 4 }, mb: { xs: 6, md: 8 }, borderRadius: '24px', border: '1px solid #f1f5f9', bgcolor: '#ffffff', boxShadow: '0 20px 40px rgba(0,0,0,0.04)' }}>
              ...
              <Box sx={{ flex: 1.2, width: '100%', minHeight: { xs: 240, md: 340 }, maxHeight: { md: 360 }, height: { xs: 'auto', md: '100%' } }}>
                <Box component="img" src={solutionImage} alt="FinOps Intelligence Dashboard Interface" sx={{ width: '100%', height: '100%', objectFit: 'cover', borderRadius: '24px', display: 'block' }} />
              </Box>
            </Card>
          </FadeUp>
            ...
            <FadeUp delay={400}>
              <Card elevation={0} sx={{ height: '100%', p: { xs: 3, sm: 4, md: 5 }, bgcolor: 'rgba(250, 245, 255, 0.5)', borderRadius: '16px', border: '1px solid #d8b4fe' }}>
                ...
                <Typography variant="body1" sx={{ color: '#ef4444', lineHeight: 1.6, fontSize: { xs: '0.95rem', md: '1.05rem' }, fontWeight: 300 }}>
                  Raw billing files obscure tracking. Teams cannot isolate product engineering costs or detect rogue cluster deployments until month-end billing audits.
                </Typography>
              </Card>
            </FadeUp>
            <FadeUp delay={500}>
              <Card elevation={0} sx={{ height: '100%', p: { xs: 3, sm: 4, md: 5 }, bgcolor: 'rgba(254, 242, 242, 0.5)', borderRadius: '16px', border: '1px solid #fca5a5' }}>
                ...
                <Typography variant="body1" sx={{ color: '#5b21b6', lineHeight: 1.6, fontSize: { xs: '0.95rem', md: '1.05rem' }, fontWeight: 300 }}>
                  Continuous LLM agent context pairing that binds billing anomalies instantly to active code commits and compute clusters.
                </Typography>
              </Card>
            </FadeUp>
          </Box>
          ...
          <Box sx={{ mb: { xs: 8, md: 12 } }}>
            ...
            <Box sx={{ display: 'grid', gridTemplateColumns: { xs: '1fr', sm: '1fr 1fr' }, gap: { xs: 2, sm: 3 } }}>
              {[
                { title: 'Intelligent Tagging Engine', desc: 'Automatic algorithmic resource matching assigns unallocated container spend to business owners.' },
                { title: 'Real-Time Spiking Guard', desc: 'Identifies unexpected cloud runaways within 15 minutes instead of standard multi-day latency gaps.' },
                { title: 'RI Recommendation Engine', desc: 'Predictive scenario logic highlighting strategic Reserved Instance allocations for maximum ROI.' },
                { title: 'Conversational Cost Auditing', desc: 'Natural language search interface enabling ad-hoc queries regarding specific infrastructure cost trends.' }
              ].map((cap, i) => (
                <Box key={i}>
          ...
          <Box sx={{ mb: { xs: 5, sm: 6, md: 8 }, textAlign: { xs: 'center', md: 'left' } }}>
            ...
            <FadeUp delay={200}>
              <Typography variant="h5" sx={{ color: '#7c3aed', fontWeight: 400, fontSize: { xs: '1rem', sm: '1.2rem', md: '1.4rem' }, maxWidth: { xs: '100%', md: '80%' }, mx: { xs: 'auto', md: 0 } }}>
                Optimize, Track & Forecast Databricks + AWS + SQL Warehouse Costs in Real Time
              </Typography>
            </FadeUp>
          </Box>
          ...
          <FadeUp delay={300}>
            ...
            >
                  ...
                  <Button
                    ...
                    endIcon={
                      <Box sx={{
                        ...
                        bgcolor: '#8b5cf6', borderRadius: '50%', width: { xs: 28, md: 32 }, height: { xs: 28, md: 32 }, ml: 1,
                        transition: 'all 0.8s ease',
                        '.MuiButton-root:hover &': { transform: 'translateX(4px)', bgcolor: '#fff' }
                      }}>
                        <ArrowForwardIcon sx={{ fontSize: 16, color: '#fff', transition: 'color 0.8s ease', '.MuiButton-root:hover &': { color: '#191529' } }} />
                      </Box>
                    }
                  >
                    Watch Demo
              ...
              {/* EXACT IMAGE CODE RETAINED */}
              <Box sx={{ flex: 1.2, width: '100%', minHeight: { xs: 240, md: 340 }, maxHeight: { md: 360 }, height: { xs: 'auto', md: '100%' } }}>
                <Box
                  component="img"
                  src={solutionImage}
                  alt="DBX Cost Calculator Dashboard"
                  sx={{
                    width: '100%',
                    height: '100%',
                    objectFit: 'cover',
          ...
          <Box sx={{ display: 'grid', gridTemplateColumns: { xs: '1fr', md: '1fr 1fr' }, gap: { xs: 3, sm: 4 }, mb: { xs: 8, md: 10 } }}>
            <FadeUp delay={400}>
              <Card elevation={0} sx={{ height: '100%', p: { xs: 3, sm: 4, md: 5 }, bgcolor: 'rgba(250, 245, 255, 0.5)', borderRadius: '16px', border: '1px solid #d8b4fe' }}>
                ...
                <Typography variant="body1" sx={{ color: '#ef4444', lineHeight: 1.6, fontSize: { xs: '0.95rem', md: '1.05rem' }, fontWeight: 300 }}>
                  Fragmented cloud costs across Databricks, AWS S3 & SQL Warehouses cause budget overruns and missed savings.
                </Typography>
              </Card>
            </FadeUp>
            ...
            <FadeUp delay={500}>
              <Card elevation={0} sx={{ height: '100%', p: { xs: 3, sm: 4, md: 5 }, bgcolor: 'rgba(254, 242, 242, 0.5)', borderRadius: '16px', border: '1px solid #fca5a5' }}>
                ...
                <Typography variant="body1" sx={{ color: '#5b21b6', lineHeight: 1.6, fontSize: { xs: '0.95rem', md: '1.05rem' }, fontWeight: 300 }}>
                  Centralized Streamlit app that tracks & forecasts cloud costs — enabling data-driven budget control.
                </Typography>
              </Card>
            </FadeUp>
          </Box>
          ...
          <Box sx={{ mb: { xs: 8, md: 12 } }}>
            ...
            <Box sx={{ display: 'grid', gridTemplateColumns: { xs: '1fr', sm: '1fr 1fr' }, gap: { xs: 2, sm: 3 } }}>
              {[
                { title: 'Comprehensive Cost Engine', desc: 'Tracks DBU, EC2, S3 tiered zones & SQL Warehouse costs in one view.' },
                { title: 'Dynamic Cost Projections', desc: 'Monthly to Annual forecasts with automated growth rate modeling.' },
                { title: 'Visual Cost Distribution', desc: 'Auto-generated charts with L0/L1/L2 tier toggles for layer-by-layer cost comparison.' },
                { title: 'Enterprise Reporting', desc: 'One-click export to multi-sheet Excel for finance teams & stakeholder reviews.' }
              ].map((cap, i) => (
                <Box key={i}>
                  <FadeUp delay={300 + (i * 100)}>
                    <Box sx={{ p: { xs: 3, sm: 4 }, bgcolor: '#ffffff', borderRadius: '16px', height: '100%', border: '1px solid #e2e8f0', transition: 'box-shadow 0.3s', '&:hover': { boxShadow: '0 10px 30px rgba(0,0,0,0.05)' } }}>
          ...
          <Box sx={{ mb: { xs: 8, md: 14 } }}>
            ...
            <Box sx={{ display: 'grid', gridTemplateColumns: { xs: '1fr', sm: '1fr 1fr', md: 'repeat(4, minmax(0, 1fr))' }, gap: { xs: 2, sm: 3 } }}>
              {[
                { value: '17', label: 'Core\nModules', color: 'linear-gradient(135deg, #ef4444 0%, #f97316 100%)', bg: 'radial-gradient(circle at 50% -20%, rgba(254, 226, 226, 0.8) 0%, #ffffff 70%)' },
                { value: 'Live', label: 'In Production\nToday', color: 'linear-gradient(135deg, #8b5cf6 0%, #3b82f6 100%)', bg: 'radial-gradient(circle at 50% 120%, rgba(243, 232, 255, 0.8) 0%, #ffffff 70%)' },
                { value: 'AI', label: 'Gemini-Powered\nInsights', color: 'linear-gradient(135deg, #ef4444 0%, #f97316 100%)', bg: 'radial-gradient(circle at 50% 120%, rgba(254, 226, 226, 0.8) 0%, #ffffff 70%)' },
                { value: '0', label: 'Manual Spark UI\nDiagnosis', color: 'linear-gradient(135deg, #8b5cf6 0%, #3b82f6 100%)', bg: 'radial-gradient(circle at 50% -20%, rgba(243, 232, 255, 0.8) 0%, #ffffff 70%)' }
              ].map((impact, i) => (
                <Box key={i}>
                  <FadeUp delay={300 + (i * 100)}>
