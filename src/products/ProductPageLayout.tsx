...
export default function ProductPageLayout({ data }: { data: ProductData }) {
  return (
    <Box sx={{ py: { xs: 10, md: 14 }, bgcolor: '#ffffff', overflow: 'hidden', position: 'relative' }}>
      ...
      <Container maxWidth="xl" sx={{ position: 'relative', zIndex: 10 }}>
        ...
        <Box sx={{ display: 'grid', gridTemplateColumns: { xs: '1fr', md: 'repeat(2, 1fr)' }, gap: 4, mb: 10 }}>
          <Box>
            <FadeUp delay={300}>
              <Card 
                elevation={0} 
        ...
        <Box sx={{ mb: 10 }}>
          <FadeUp delay={200}>
            <Typography variant="h3" component="h2" sx={{ color: '#1e293b', mb: 6, textAlign: 'center', fontWeight: 300 }}>Core Capabilities</Typography>
          </FadeUp>
        ...
        <FadeUp delay={500}>
          <Box sx={{ bgcolor: '#0f172a', borderRadius: '32px', p: { xs: 4, md: 8 }, color: '#fff', textAlign: 'center' }}>
            <Typography variant="h4" component="h2" sx={{ color: '#f87171', mb: 6, fontWeight: 300 }}>Proven Impact</Typography>
