...
import solutionImage from '../assets/solution/solution1.png'; // Make sure this asset exists
...
export default function MetaFlowPage() {
  useEffect(() => { document.title = "Meta Flow | NRM Analytix"; }, []);
          ...
          <FadeUp delay={300}>
            <Card elevation={0} sx={{ display: 'flex', flexDirection: { xs: 'column', md: 'row' }, alignItems: 'stretch', gap: { xs: 3, md: 6 }, px: { xs: 3, md: 5 }, py: { xs: 2.5, md: 4 }, mb: { xs: 6, md: 8 }, borderRadius: '24px', border: '1px solid #f1f5f9', bgcolor: '#ffffff', boxShadow: '0 20px 40px rgba(0,0,0,0.04)' }}>
              ...
              <Box sx={{ flex: 1.2, width: '100%', minHeight: { xs: 240, md: 340 }, maxHeight: { md: 360 }, height: { xs: 'auto', md: '100%' } }}>
                <Box component="img" src={solutionImage} alt="Meta Flow Architecture Map" sx={{ width: '80%', height: '100%', objectFit: 'cover', borderRadius: '24px', display: 'block' }} />
              </Box>
            </Card>
          </FadeUp>
