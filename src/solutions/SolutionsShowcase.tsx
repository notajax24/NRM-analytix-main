...
import Solution1Img from '../assets/solution/solution1.png';
import Solution2Img from '../assets/solution/solution2.png';
import Solution3Img from '../assets/solution/solution3.png';
import Solution4Img from '../assets/solution/solution4.png';

const solutionsData = [
  {
    title: 'Meta Flow',
    description: 'Intelligent metadata management and automated data lineage tracking for enterprise data platforms. Gain complete visibility into your data assets, improve governance, and accelerate compliance — without the manual overhead.',
    image: Solution1Img, 
    size: { xs: 12, md: 5 }, // Top Left: Narrow
    path: '/products/meta-flow'
  },
  {
    title: 'DBX Cost Calculator',
    description: 'Optimise your Databricks spend with real-time cost estimation, cluster configuration recommendations, and usage analytics. Built specifically for data teams running workloads on Databricks — reduce waste and forecast costs with confidence.',
    image: Solution2Img,
    size: { xs: 12, md: 7 }, // Top Right: Wide
    path: '/products/dbx-cost-calculator'
  },
  {
    title: 'FinOps Copilot',
    description: 'AI-powered cloud cost governance and financial operations automation for data engineering teams. Gain real-time visibility into cloud spend, automate cost allocation, and enforce FinOps best practices across your entire data platform.',
    image: Solution3Img,
  ...
  },
  {
    ...
    description: 'Empower your recruiting teams with AI-driven insights to analyze job descriptions, identify talent gaps, and streamline the hiring process.',
    image: Solution4Img,
        ...
        <Grid container spacing={4}>
          {solutionsData.map((solution, index) => (
            <Grid size={{ xs: solution.size.xs as any, md: solution.size.md as any }} key={index}>
              ...
              >
              {/* Top Row: Button (Left) and Image (Right) - Reduced gap and margins */}
              <Box sx={{ display: 'flex', flexDirection: { xs: 'column-reverse', lg: 'row' }, justifyContent: 'space-between', alignItems: 'flex-start', mb: 3, gap: 2 }}>
                ...
                <Box
                  ...
                  sx={{
                    ...
                    minWidth: 0,
                    borderRadius: '16px', // Distinct rounded corners matching design
                    objectFit: 'cover', // Forces the image to completely fill the box, removing white space
                    objectPosition: 'center', // Centers the image to prevent awkward cropping
                    display: 'block',
